...
An elementary yet striking example of this idea is the \defn{permutahedron} $\Perm (n)$, defined as the convex hull of the points $\sum_{i\in [n]} \sigma^{-1}(i)\cdot \mathbf{e}_i$, for all permutations $\sigma \in \f{S}_n$.
...
\vincent{More citations on electronic engineering...}
