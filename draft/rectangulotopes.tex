...
From \cref{thm:weakCong}, we obtain a bijection between the cover relations in the weak poset and the facets of the dual cone corresponding to the rectangulation, which are in turn one-to-one with feasible flips in the rectangulation.
...
Note that, similarly to the weak case, \cref{thm:strongCong} yields a bijection between the cover relations in the strong poset and the facets of the dual cone corresponding to the rectangulation, which are in turn one-to-one with feasible flips in the rectangulation.
