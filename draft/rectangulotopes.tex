...
\label{subsec:weakStrongRectangulations}
...
%  Given a down arc~$\alpha$ defined by an interval $I$, the down shard polytope $\SP(\alpha)$ is a translate of the negative standard simplex~$\conv \set{ - \b{e}_i }{ i\in I }$.
