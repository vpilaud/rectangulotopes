...
A natural object associated with the associahedron is the \defn{Tamari lattice}, whose cover graph is isomorphic to the skeleton of the associahedron.
The Tamari lattice is known to be the quotient of the weak Bruhat order by a \defn{lattice congruence} called the \defn{sylvester congruence}.
...
Its classes are in bijection with weak rectangulations, but also with \defn{twin binary trees}~\cite{Giraudo}, and with \defn{Baxter permutations}~\cite{}. % more baxter refs
...
The \defn{strong rectangulation congruence} was introduced by N.~Reading~\cite{MR2864445}, revisited in~\cite[Thm.~1.2 \& Exm.~4.11]{Reading-arcDiagrams} in terms of arc diagrams, and studied more recently by A.~Asinowski, J.~Cardinal, S.~Felsner, and É.~Fusy~\cite{ACFF24}.
...
\begin{figure}[b]
	...
	\caption{The braid fan (left) and the sylvester fan (right). \cite[Fig.~1]{PilaudSantos-quotientopes} \&~\cite[Fig.~5]{PadrolPilaudRitter}}
	\label{fig:fans}
\end{figure}
...
\begin{figure}
	...
	\caption{The permutahedron~$\Perm(4)$ (left) and the associahedron~$\Asso(4)$. \cite[Fig.~1]{PilaudSantos-quotientopes} \&~\cite[Fig.~5]{PadrolPilaudRitter}}
