...
\Vincent{
weak and strong classes of quadrangulations.
Source and target tree. Only definition. Only depend on the weak class.
Formulas with no explanation.
Proofs and connection to quotientopes later.
}
