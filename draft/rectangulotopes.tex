...
\begin{figure}
	...
	\caption{The braid fan (left) and the sylvester fan (right). \cite[Fig.~1]{MR3964495}}
	\label{fig:fans}
\end{figure}
...
\begin{figure}
	...
	\caption{The permutahedron~$\Perm(4)$ (left) and the associahedron~$\Asso(4)$. \cite[Fig.~1]{MR3964495}}
...
xGiven a rectangulation~$R$, the source and target trees~$S(R)$ and~$T(R)$ define two partial orders on $[n]$ (the horizontal edges are oriented from left to right and the vertical edges are oriented from bottom to top).
