...
The coordinates of the vertices corresponding to each weak rectangulation are gathered in \cref{tab:verticesWeakRectangulotope}.
\vincent{add table for the facets}
...
The coordinates of the vertices corresponding to each strong rectangulation are gathered in \cref{tab:verticesStrongRectangulotope}.
\vincent{add table for the facets}
