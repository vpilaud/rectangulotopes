...
Note that there is a bijection between the facets of~$C_R$, the cover relations of~$\preccurlyeq_w$, and the flips from~$R$.
...
Note that there is a bijection between the facets of~$C_R$, the cover relations of~$\preccurlyeq_s$, and the flips from~$R$.
