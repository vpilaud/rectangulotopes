...
Its classes are in bijection with with weak rectangulations, but also with \defn{twin binary trees}~\cite{Giraudo}, and with \defn{Baxter permutations}~\cite{}. % more baxter refs
...
The \defn{strong rectangulation congruence} was introduced by N.~Reading~\cite{MR2864445}, revisited in~\cite[Thm.~1.2 \& Exm.~4.11]{Reading-arcDiagrams}, and studied more recently by A.~Asinowski, J.~Cardinal, S.~Felsner, and É.~Fusy~\cite{ACFF24}.
